...
INSERT INTO "new_User" ("active", "createdAt", "customerId", "email", "id", "name", "providerGroupId", "updatedAt", "username") SELECT "active", "createdAt", "customerId", "email", "id", "name", "providerGroupId", "updatedAt", "username" FROM "User";
DROP TABLE "User";
