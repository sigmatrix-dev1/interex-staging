...
/** Only allow breadcrumb/cards that match these paths (Session Security only). */
const ALLOWED_PATH_SUBSTRINGS = ['/settings/profile/two-factor']
...
export default function EditUserProfile() {
    ...
    const breadcrumbs = matches
        .filter((m) =>
            ...
            ALLOWED_PATH_SUBSTRINGS.some((p) => m.pathname.includes(p)),
        )
        .map((m) => {
